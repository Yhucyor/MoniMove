...
export default function RealtimeStatusBar({
    ...
    return (
        <div
            className={`flex items-center gap-3 rounded-xl border px-3 py-2 text-[10px] font-bold transition-all ${isConnected
        ...
        >
            ...
            {isConnected && lastUpdateAt && (
                <span className="flex items-center gap-1 text-emerald-600">
                    ...
                    {new Date(lastUpdateAt).toLocaleTimeString('vi-VN', { hour: '2-digit', minute: '2-digit', second: '2-digit' })}
                </span>
            )}
