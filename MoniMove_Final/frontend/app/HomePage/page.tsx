...
import ActivityHistoryTab from '../../src/features/dashboard/ActivityHistoryTab';
...
import GeofencingTab from '../../src/features/dashboard/GeofencingTab';
...
export default function DashboardPage() {
  ...
  const [historyDeviceId, setHistoryDeviceId] = useState<string | undefined>();
  ...
  const handleNavigate = (tab: string, deviceId?: string) => {
    if (deviceId) setHistoryDeviceId(deviceId);
    setActiveTab(tab);
  };
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'activity_history':
        return <ActivityHistoryTab initialDeviceId={historyDeviceId} />;
      case 'alerts_history':
