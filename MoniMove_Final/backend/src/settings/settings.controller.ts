...
export class SettingsController {
  ...
  @Get(':deviceId')
  @ApiOperation({ summary: 'Lấy cài đặt thiết bị', description: 'Đọc cài đặt ngưỡng, SOS email, v.v. từ Firebase RTDB' })
  ...
  @Put(':deviceId')
  @ApiOperation({ summary: 'Lưu cài đặt thiết bị', description: 'Ghi/merge cài đặt vào Firebase RTDB' })
  @ApiParam({ name: 'deviceId', example: 'DEVICE_ESP32_01' })
  async saveSettings(
