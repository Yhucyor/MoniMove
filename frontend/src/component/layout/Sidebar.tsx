...
export default function Sidebar({ isOpen, onClose, activeTab, onTabChange }: SidebarProps) {
  ...
  return (
    <aside
      ...
      className={`fixed left-0 top-0 z-50 flex h-full w-48 flex-col justify-between border-r border-slate-200/50 bg-gradient-to-tr from-[#eef7f8] via-[#f4f3f8] to-[#fbeff5] pl-3 py-3 pr-0 shadow-2xl transition-transform duration-300 ease-in-out overflow-hidden animated-gradient-bg ${
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-6">
        <div 
          className={`flex select-none items-center justify-start px-1.5 py-1 pr-4 transition-all duration-500 ${
      ...
      <div 
        ...
        className={`relative z-10 flex flex-col gap-2 border-t border-slate-200/80 pt-3 pr-3 transition-all duration-500 transform ${
